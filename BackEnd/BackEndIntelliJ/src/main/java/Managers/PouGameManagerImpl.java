...
public class PouGameManagerImpl implements PouGameManager {
    ...
    public List<ObjetoArmario> obtenerArmarioOrdenadoDescendentemente (String columnaId){return null;}

    public List<ObjetoTienda> obtenerTiendaOrdenadaDescendentemente(String columnaId){return null;}
}
